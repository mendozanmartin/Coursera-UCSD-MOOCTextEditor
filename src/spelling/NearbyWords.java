	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while(!queue.isEmpty() && retList.size() < numSuggestions){
			...
			for (String individWord : words){
				if (!visited.contains(individWord) && retList.size() < numSuggestions){
					visited.add(individWord);
					queue.add(individWord);
					if(dict.isWord(individWord)){
						retList.add(individWord);
					}
				}
			}
		}
